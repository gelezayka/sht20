...
extern volatile unsigned char xdata PETITMODBUS_SLAVE_ADDRESS;                                 // Petit Modbus RTU Slave icin adres numarasi [0 to 255]
...
extern PetitRegStructure  xdata  PetitRegisters[NUMBER_OF_OUTPUT_PETITREGISTERS];
